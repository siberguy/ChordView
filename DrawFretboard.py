...
def On_Draw(canvas,RW,RH,RM,key,chord):
    DrawFretboard(canvas,RW,RH,RM,key,chord)

def DrawFretboard(canvas,RW,RH,RM,key,chord):
        #dc = wx.PaintDC(self)
...
#            elif not (i % 2): dc.DrawLine(i+RM, 0, i+RM, 4)
        ...
        draw_notes(canvas,key,chord,fret_spacing,fret_spacing,string_spacing,string_spacing)

        return



def draw_notes(canvas,key,chord,f1,df,s1,ds):
        note = 0
        s1 = s1+13
        ds = ds - 5
